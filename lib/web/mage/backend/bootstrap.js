        ...
        error: function () {
            $('body').notification('clear')
                .notification('add', {
                    error: true,
                    message: $.mage.__(
                        'A problem occurred in communicating with the Magento server. ' +
                        'Retry the operation or reload the page. If the problem persists, check your browser console for errors or contact your administrator.'
                    ),
